...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.7.1/SENTSDK-spm-6.7.1.xcframework.zip",
            checksum: "ac2119077d01bc3a5ad066ea5a90197a0fbe947a6bafe22f16a24255ee4768d2"
        ),
        .binaryTarget(
