...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.5.0/SENTSDK-spm-6.5.0.xcframework.zip",
            checksum: "7c663161ab53692f44e59dd38abcb30194a86198454e2c4ef99c4c5f8bd24457"
        ),
        .binaryTarget(
