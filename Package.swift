...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.8.3/SENTSDK-spm-6.8.3.xcframework.zip",
            checksum: "52038e899c157ce342b885f1d0611cb7e699390c9833243ae1c46a70c0f5b056"
        ),
        .binaryTarget(
