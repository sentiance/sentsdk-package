...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.7.0/SENTSDK-spm-6.7.0.xcframework.zip",
            checksum: "594f96db5575d8efbdf4163dc338179db6ce436da7b59bdca716994b110c40bc"
        ),
        .binaryTarget(
