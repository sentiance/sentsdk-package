...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.5.2/SENTSDK-spm-6.5.2.xcframework.zip",
            checksum: "b85712f82a3fbbff13f927c4f0ec74d1032d5f542a7965b82327b971f4bd73db"
        ),
        .binaryTarget(
