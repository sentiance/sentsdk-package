...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.2.4/SENTSDK-spm-6.2.4.xcframework.zip",
            checksum: "1366156f07cd79949c436492708859fd7e80eebca599afcd902cd059b4c76a0e"
        ),
        .binaryTarget(
