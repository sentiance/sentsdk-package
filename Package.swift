...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.9.0-rc1.customer.hourglass.sensitive.3/SENTSDK-spm-6.9.0-rc1.customer.hourglass.sensitive.3.xcframework.zip",
            checksum: "d9caab70ffa209370376285bcf0e070a0068c91ba7ad8a51d99799d39b93b607"
        ),
        .binaryTarget(
            name: "TensorFlowLiteC",
