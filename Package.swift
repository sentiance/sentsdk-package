...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.6.4/SENTSDK-spm-6.6.4.xcframework.zip",
            checksum: "112a2589ef8b086376dea1c3beee4c5f34acdeac68c7e4531593c5a78a4076d3"
        ),
        .binaryTarget(
