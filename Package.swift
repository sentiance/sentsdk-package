...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.2.3/SENTSDK-spm-6.2.3.xcframework.zip",
            checksum: "162f31eddfd9f99473d9182bbb1a1f7e8a1fec5b1e053b93340600c96c2ad126"
        ),
        .binaryTarget(
