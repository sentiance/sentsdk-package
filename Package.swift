...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.2.0-rc2/SENTSDK-spm-6.2.0-rc2.xcframework.zip",
            checksum: "b2c1f9f815dbf87a2ef925517a58b6d54b09e6a17727d0846ca6177223d3d704"
        ),
        .binaryTarget(
        ...
        .binaryTarget(
            name: "dskoball",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/dskoball/1.0.4/dskoball.xcframework.zip",
            checksum: "dc60d339f58c4985d9fdfd52fa259abba8c7feffab9b24ea4d82f898ab4ef1b8"
        )
    ],
