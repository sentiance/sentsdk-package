...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.7.2/SENTSDK-spm-6.7.2.xcframework.zip",
            checksum: "623de1ec84948edb4ec372d0527e9f6b288bda6d207657741abc1871bfaee62f"
        ),
        .binaryTarget(
