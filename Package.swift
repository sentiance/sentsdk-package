...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.1.0/SENTSDK-spm-6.1.0.xcframework.zip",
            checksum: "9fedb381807711308e6b511675821939e4ce57d9da74311a4069700b407dcdc5"
        ),
        .binaryTarget(
