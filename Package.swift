...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.6.1/SENTSDK-spm-6.6.1.xcframework.zip",
            checksum: "51a8c0e2712b74f76679ce8ada71b483987136342fb8270daaef0e4978efea4a"
        ),
        .binaryTarget(
