...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.0.3/SENTSDK-spm-6.0.3.xcframework.zip",
            checksum: "4f336e8d13b96f7be2e2ee71c309bf3f0b991aae91fc257f10f995fb520ddcb1"
        ),
        .binaryTarget(
