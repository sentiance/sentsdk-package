...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.4.0/SENTSDK-spm-6.4.0.xcframework.zip",
            checksum: "88223c357eaca570b00ffd97a49e881f7efb4531b7261c5082fc21024826a825"
        ),
        .binaryTarget(
