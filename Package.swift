...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.8.6/SENTSDK-spm-6.8.6.xcframework.zip",
            checksum: "e93bc2ee59cc73826b7417e06d7b2b18d6a7b1af3ce5503f7e0279f68486e3c7"
        ),
        .binaryTarget(
