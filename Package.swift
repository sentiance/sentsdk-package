...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "SENTSDK",
            url: "https://sentiance-u1-sdk-downloads.s3.eu-west-1.amazonaws.com/ios/frameworks/SENTSDK/6.6.2/SENTSDK-spm-6.6.2.xcframework.zip",
            checksum: "777edacb94f9c10f26c34ef2ffbd11fca8b221bcbb58a4c79dda92d48f0dc22e"
        ),
        .binaryTarget(
